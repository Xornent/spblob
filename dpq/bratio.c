...
static void bgrat(double, double, double, double, double *, double, int *, bool_t log_w);
...
static void bgrat(double a, double b, double x, double y, double *w,
				  double eps, int *ierr, bool_t log_w)
{
	/* -----------------------------------------------------------------------
...
#define n_terms_bgrat 30
	...
	bool_t u_0 = (u == 0.); // underflow --> do work with log(u) == log_u !
