...
#define verbose
    ...
    for (int i = 0; i < paired.size(); i++)
    {
        ...
        cv::Point2d orig_b1((origin.x + unifx * 150.) / zoom, (origin.y + unify * 150.) / zoom); // FIXME: CHANGE
        cv::Point2d orig_b2((origin.x + unifx * 170.) / zoom, (origin.y + unify * 170.) / zoom); // FIXME: CHANGE
